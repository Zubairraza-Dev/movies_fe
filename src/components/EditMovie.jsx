...
const EditMovie = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      delete data.image;
      const response = await httpRequest.patch(`${MOVIES}/${id}`, data);
  ...
  return (
    <div className="bg-[#093545] w-full h-auto flex flex-col gap-24">
      <div className="w-[94%] sm:w-[75%] mx-auto flex flex-col mt-[80px] sm:mt-[120px]">
        <div className="text-[32px] sm:text-[48px] sm:w-auto w-[380px] mx-auto sm:mx-0 font-semibold text-white text-start sm:mb-[120px] mb-[80px] font-custom">
          Edit
        </div>
